...
<span class="inline-flex items-center whitespace-nowrap min-w-0" title={account}><AccountBadge account={account} size={resolvedSize} />{#if sub}<span class="truncate font-mono {textClass} {accountColor(account)}">:{sub}</span>{/if}</span>
