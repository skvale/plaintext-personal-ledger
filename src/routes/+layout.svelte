<script lang="ts">
  ...
  const glossaryTerms = [
    {
      term: "Transaction",
      def: "A financial event — buying groceries, getting paid, transferring money. Each transaction has a date, description, and two or more postings.",
    },
    {
      term: "Posting",
      def: "One line of a transaction. A $50 grocery purchase has two postings: +$50 to expenses:food and −$50 from assets:checking. Postings always balance to zero.",
    },
    {
      term: "Account",
      def: "A category for money. Organized in a tree like folders: assets:bank:checking, expenses:food:restaurants. There are 5 top-level types: assets, liabilities, income, expenses, equity.",
    },
    {
      term: "Journal",
      def: "The plain text file where all your transactions live. It's the single source of truth for your finances — human-readable and version-controlled.",
    },
    {
      term: "Debit",
      def: 'The "where money went" side of a transaction. Buying $50 of groceries puts a $50 debit on expenses:food — your food spending went up by $50.',
    },
    {
      term: "Credit",
      def: 'The "where money came from" side. That same grocery purchase puts a $50 credit on checking — $50 left your bank account to pay for it.',
    },
    {
      term: "Double-Entry",
      def: "Every transaction affects at least two accounts. Money never appears or disappears — it just moves. This is why all postings in a transaction sum to zero.",
    },
    {
      term: "Balance Sheet",
      def: "A snapshot of what you own (assets) vs. what you owe (liabilities) at a point in time. The difference is your net worth.",
    },
    {
      term: "P&L / Income Statement",
      def: "A summary of money in (income) vs. money out (expenses) over a time period. Shows whether you're saving or overspending.",
    },
    {
      term: "Reconcile",
      def: 'Confirming your records match your bank\'s records. Mark transactions as "cleared" once verified. Catches errors and missing entries.',
    },
    {
      term: "Net Worth",
      def: "Assets minus liabilities. Everything you own minus everything you owe. The single number that summarizes your financial position.",
    },
    {
      term: "Commodity",
      def: "The unit of an amount — usually a currency like USD or EUR, but can also be stock shares (AAPL), crypto (BTC), or anything you track.",
    },
    {
      term: "Forecast",
      def: "A projection of future transactions based on your recurring rules. Shows what your balances will look like if nothing unexpected happens.",
    },
    {
      term: "Budget",
      def: "A spending target you set for an account (usually expenses). Compare what you planned to spend vs. what you actually spent.",
    },
    {
      term: "Vendor",
      def: "Who you paid or who paid you. The name that appears on a transaction — a store, employer, landlord, etc.",
    },
    {
      term: "Recurring",
      def: "A transaction that happens on a schedule — rent, subscriptions, paychecks. Defined as rules that generate forecast entries.",
    },
    {
      term: "Cost Basis",
