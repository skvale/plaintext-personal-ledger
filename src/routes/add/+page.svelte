...
<LearningBanner id="add-transaction" title="How postings work" tips={[
  ...
  { text: 'Track investments using hledger\'s <strong>cost notation</strong>. When buying, record <span class="inline-flex whitespace-nowrap items-center"><span class="inline-flex shrink-0 rounded border font-mono font-semibold capitalize align-text-bottom px-0.5 py-0 text-xs leading-4 border-[#93c5fd] bg-[#eff6ff] text-[#1d4ed8] dark:border-blue-300/20 dark:bg-blue-300/10 dark:text-blue-500">Assets</span><span class="font-mono text-xs text-blue-500">:investments:vanguard</span></span> <code>10 VTI @ $100</code> — hledger tracks both share count and cost basis. Use <code>P 2026-01-15 VTI $125</code> price directives to record market prices. The Portfolio page shows cost basis vs. market value automatically.' },
]} />
